...
class TestSetupProviderProfiles(unittest.TestCase):
    ...
    def test_required_provider_names_skips_candidates_for_part_of_conversation(self) -> None:
        cfg = self._build_config()
        cfg.run.final_response_source = "part_of_conversation"
        self.assertEqual(required_provider_names(cfg), {"google_genai"})
